        ...
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-">
                ...
                <p className="text-center">
                    Powering Your Growth with Unbreakable <span className="sm:text-7xl font-bold text-transparent bg-gradient-to-br from-slate-300  via-blue-800  to-slate-500  bg-clip-text ">Security</span>
                </p>
            ...
            <div className="border-y border-slate-700 p-10 my-10">
                <div className="flex overflow-hidden space-x-16 group">
                    ...
                    <div className="flex space-x-16 animate-loop-scroll group-hover:paused cursor-pointer">
                        ...
                        <div onClick={() => navigate('/')} className="w-60 p-2 border border-slate-700 rounded-md ">
